...
Original file is located at
    https://colab.research.google.com/drive/12kds0Sm0QVdYJlaCfxMLDe1mRbk1Ikln
"""
...
from mtcnn import MTCNN  # Library for face detection

from google.colab import drive
drive.mount('/content/drive')

# Load and preprocess images
image_size = (124, 124)  # Ukuran gambar untuk CNN
data_dir = '/content/drive/My Drive/face_recognition_dataset/'  # Path ke dataset
...
def detect_face(img):
    ...
    if result:
        ...
        # Resize cropped face to a fixed size (112x112)
...
for folder in os.listdir(data_dir):
    files = os.listdir(os.path.join(data_dir, folder))[:150]
    if len(files) < 50 :
        continue
    for i, name in enumerate(files):
        if name.find(".jpg") > -1 :
            img = cv2.imread(os.path.join(data_dir + folder, name))
...
model.save("/content/drive/My Drive/model/model-cnn-facerecognition.keras")
...
model = load_model("/content/drive/My Drive/model/model-cnn-facerecognition.keras")
